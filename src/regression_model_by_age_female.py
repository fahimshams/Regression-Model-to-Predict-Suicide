...
# Define age groups
age_groups = ['Female: 10-14 years', 'Female: 15-24 years', 'Female: 25-34 years',
              'Female: 35-44 years', 'Female: 45-64 years', 'Female: 65 years and over']
...
plt.title('Linear Regression Model by Female Age Group')
plt.legend()
plt.show()