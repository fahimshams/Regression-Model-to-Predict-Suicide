...
age_groups = ['Male: 10-14 years', 'Male: 15-24 years', 'Male: 25-34 years', 'Male: 35-44 years', 'Male: 45-64 years', 'Male: 65 years and over']
...
plt.title('Linear Regression Model by Male Age Group - Future Predictions')
plt.legend()
plt.show()
